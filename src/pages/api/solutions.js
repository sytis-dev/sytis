...
export default async function handler(req, res) {
  ...
  try {
    ...
    if (fromCache && !isStale) {
      console.log('Solutions: Using fresh cached categories');
    } else if (fromCache && isStale) {
      console.log('Solutions: Using stale cached categories, revalidating in background');
    } else {
      console.log('Solutions: Fetched fresh categories from API');
    }
    ...
    addVercelCacheHeaders(res, VERCEL_CACHE_CONFIG.SOLUTIONS);
