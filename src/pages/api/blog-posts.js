export default async function handler(req, res) {
    ...
    try {
        ...
        const postsResponse = await fetch(`https://api.bigcommerce.com/stores/${storeHash}/v2/blog/posts`, {
            method: "GET",
            headers: {
        ...
        const publishedPosts = postsData.filter(post => post.is_published).map(post => ({
            id: post.id,
            author: post.author,
            title: post.title,
            body: post.body,
